...
const PortfolioContact = ({ language }) => {
  const translations = {
    en: {
      title: "<Contact />",
      description: "Find me on my social media and let's connect!",
      links: {
        whatsapp: "WhatsApp",
        instagram: "Instagram",
        facebook: "Facebook",
    ...
    es: {
      title: "<Contacto />",
      description: "Encuéntrame en mis redes sociales y conectemos!",
      links: {
        whatsapp: "WhatsApp",
        instagram: "Instagram",
        facebook: "Facebook",
