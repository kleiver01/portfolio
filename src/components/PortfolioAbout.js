...
<p className="text-lg md:text-xl leading-relaxed mb-6 text-gray-200 group-hover:text-white transition-colors duration-300 typing-effect">
  {Array.from("Greetings, friend! I'm a digital experience programmer, a code wizard.").map((char, i) => (
        ...
        <div className="relative group">
          ...
          >
            <span className="flex items-center space-x-5">
              ...
              <span className="pr-6 text-gray-100 text-lg font-bold">My Code</span>
            </span>
            <span className="pl-6 text-purple-400 group-hover:text-gray-100 transition duration-200 text-lg font-bold">View on GitHub</span>
          </a>
        </div>
      </div>
    </div>
